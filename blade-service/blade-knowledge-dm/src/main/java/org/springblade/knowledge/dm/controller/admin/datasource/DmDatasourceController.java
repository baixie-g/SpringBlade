package org.springblade.knowledge.dm.controller.admin.datasource;
...
public class DmDatasourceController extends BaseController {
    ...
    public void export(HttpServletResponse response, DmDatasourcePageReqVO exportReqVO) {
        ...
        util.exportExcel((jakarta.servlet.http.HttpServletResponse) response, DmDatasourceConvert.INSTANCE.convertToRespVOList(list), "应用管理数据");
    }
