package org.springblade.common.database.dialect;


import org.apache.commons.lang3.StringUtils;
import org.springframework.jdbc.core.RowMapper;
import org.springblade.common.database.constants.DbQueryProperty;
import org.springblade.common.database.core.DbColumn;
import org.springblade.common.database.core.DbTable;
import org.springblade.common.database.utils.MD5Util;
...
public class OracleDialect extends AbstractDbDialect {
    ...
    private List<String> generateOracleCreateSql(String tableName, String tableComment, List<DbColumn> columns) {
        ...
        for (DbColumn col : columns) {
            ...
            if (org.springblade.common.utils.StringUtils.hasText(col.getDataDefault())) {
                String columnType = col.getDataType();
        ...
        // 表注释
        if (org.springblade.common.utils.StringUtils.hasText(tableComment)) {
            String tableCmt = "COMMENT ON TABLE " + tableName + " IS '" + MD5Util.escapeSingleQuotes(tableComment) + "'";
            sqlList.add(tableCmt);
        }
        // 字段注释
        for (DbColumn col : columns) {
            if (org.springblade.common.utils.StringUtils.hasText(col.getColComment())) {
